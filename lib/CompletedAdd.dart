...
class CompletedAdd extends StatelessWidget {
  CompletedAdd({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 31.0, 343.0, 40.0),
                    size: Size(343.0, 71.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 31.0, 163.0, 40.0),
                    size: Size(163.0, 71.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 40.0, 81.0, 21.0),
                    size: Size(163.0, 71.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 40.0, 53.0, 21.0),
                    size: Size(163.0, 71.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 31.0, 287.0, 40.0),
                    size: Size(343.0, 71.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 40.0, 130.0, 21.0),
                    size: Size(343.0, 71.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
