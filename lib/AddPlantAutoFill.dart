...
class AddPlantAutoFill extends StatelessWidget {
  AddPlantAutoFill({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 71.0, 343.0, 134.0),
                    size: Size(343.0, 205.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 36.0, 33.0, 21.0),
                    size: Size(343.0, 205.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 81.0, 41.0, 21.0),
                    size: Size(343.0, 205.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 121.0, 130.0, 21.0),
                    size: Size(343.0, 205.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 161.0, 107.0, 21.0),
                    size: Size(343.0, 205.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
